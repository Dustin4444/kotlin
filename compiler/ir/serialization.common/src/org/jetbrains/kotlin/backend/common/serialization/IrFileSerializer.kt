...
open class IrFileSerializer(
    ...
    private val originalToPreprocessedInlineFunctions = mutableMapOf<IrSimpleFunction, IrSimpleFunction>()
    ...
    private fun serializeIrFunction(declaration: IrSimpleFunction): ProtoFunction {
        declaration.erasedTopLevelCopy?.let { originalToPreprocessedInlineFunctions[declaration] = it }
